  ...
  return (
    <div className="flex flex-col-reverse">
      {encounters.map((encounter, i) => (
        <Transition
          key={encounter.id}
          in={!encounter.deleted}
          appear={!!encounter.created}
          timeout={{ exit: 500 }}
        >
          {(state) => (
            <div
            ...
            >
              <div className="flex w-full">
                ...
                <div className="flex-none bg-gray-100 w-0.5 h-10 m-2"></div>
                <div className="flex-grow" />
              </div>
              <div className="flex w-full">
                <div className="flex-grow" />
                <div className="flex-none border-solid border-2 font-bold p-4 rounded text-center">
                  <div className="mb-2">
                    ...
                    {props.userCampaign.admin && (
                      <TrashIcon
                        className="text-gray-300 hover:text-gray-600 inline-block h-4 w-4"
      ...
      {props.userCampaign.admin && (
        <div className="flex w-full">
          <div className="flex-grow" />
          <button
            className="flex-none border-solid border-2 font-bold py-2 px-4 rounded hover:bg-gray-100"
